...
def runSetup():
    ...
    pycryptodome = 'pycryptodome==3.6.4'
    psutil = 'psutil==3.0.1'
    protobuf = 'protobuf==3.6.0'
    azureCosmosdbTable = 'azure-cosmosdb-table==1.0.4'
    azureAnsible = 'ansible[azure]==2.5.0a1'
    azureStorage = 'azure-storage==1.3.0'
    secretstorage = 'secretstorage<3'
    pynacl = 'pynacl==1.2.1'
    gcs = 'google-cloud-storage==1.10.0'
    gcs_oauth2_boto_plugin = 'gcs_oauth2_boto_plugin==2.1'
    apacheLibcloud = 'apache-libcloud==2.3.0'
    cwltool = 'cwltool==1.0.20180622214234'
    schemaSalad = 'schema-salad>=2.6, <3'
    galaxyLib = 'galaxy-lib==18.5.13'
    htcondor = 'htcondor>=8.7.0'
    dill = 'dill==0.2.8.2'
    six = 'six>=1.11.0'
    future = 'future'
