...
def runSetup():
    ...
    azureStorage = 'azure-storage==1.3.0'  # Success 'azure-storage==0.35.1'
    secretstorage = 'secretstorage<3'
    pynacl = 'pynacl==1.2.1'  # Success 'pynacl==1.1.2'
    gcs = 'google-cloud-storage==1.10.0'  # Success     gcs = 'google-cloud-storage==1.6.0'
    ...
    future = 'future'
    requests = 'requests==2.18.4'  # Success 'requests==2.18.4'
